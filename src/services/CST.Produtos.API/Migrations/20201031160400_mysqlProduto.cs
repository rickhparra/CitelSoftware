...
{
    public partial class mysqlProduto : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descricao = table.Column<string>(type: "varchar(500)", maxLength: 200, nullable: false),
                    ...
                    CategoriaId = table.Column<string>(type: "varchar(100)", nullable: false)
                },
                constraints: table =>
                {
